...
public class DetailsFragment extends Fragment implements DetailsView, View.OnClickListener {
    ...
    @Inject
    DetailsPresenter movieDetailsPresenter;
    ...
    public static DetailsFragment getInstance(@NonNull Movie movie)
    {
        Bundle args = new Bundle();
        args.putParcelable("movie", movie);
        DetailsFragment movieDetailsFragment = new DetailsFragment();
    ...
    public void showDetails(Movie movie)
    {
        ...
        releaseDate.setText(String.format("Release date", movie.getReleaseDate()));
        rating.setText(String.format("Rating", String.valueOf(movie.getVoteAverage())));
